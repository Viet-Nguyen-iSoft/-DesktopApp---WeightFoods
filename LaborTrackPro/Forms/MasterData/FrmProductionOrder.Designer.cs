...
{
  partial class SettingProductionOrder
  {
    /// <summary>
    ...
    private void InitializeComponent()
    {
      ...
      tableLayoutPanel1.Size = new Size(1284, 591);
      ...
      tableLayoutPanel2.Size = new Size(1264, 60);
      ...
      dgv.Columns.AddRange(new DataGridViewColumn[] { No, NameProductionOrder, Column4, Column2, Column3, Column5, Column1, Update, btnDetail });
      ...
      NameProductionOrder.HeaderText = "Tên";
      ...
      Column3.DataPropertyName = "Datetime";
      Column3.HeaderText = "Hiệu lực";
      ...
      // Column5
      // 
      Column5.DataPropertyName = "Warning";
      Column5.HeaderText = "Cảnh báo";
      ...
      // 
      // SettingProductionOrder
      // 
      AutoScaleDimensions = new SizeF(7F, 15F);
      AutoScaleMode = AutoScaleMode.Font;
      ClientSize = new Size(1284, 591);
      Controls.Add(tableLayoutPanel1);
      Name = "SettingProductionOrder";
      Text = "FrmSettingOrderProduct";
