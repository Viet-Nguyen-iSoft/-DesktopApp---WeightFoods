...
{
  partial class FrmChooseExportImport
  {
    /// <summary>
    ...
    private void InitializeComponent()
    {
      ...
      tableLayoutPanel1.RowStyles.Add(new RowStyle(SizeType.Percent, 10F));
      tableLayoutPanel1.Size = new Size(1113, 559);
      tableLayoutPanel1.TabIndex = 2;
      // 
      // flowLayoutPanel
      // 
      flowLayoutPanel.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
      flowLayoutPanel.Location = new Point(15, 145);
      flowLayoutPanel.Margin = new Padding(0);
      flowLayoutPanel.Name = "flowLayoutPanel";
      flowLayoutPanel.Size = new Size(1083, 367);
      ...
      ucTitleFrm.Size = new Size(1083, 85);
      ucTitleFrm.TabIndex = 2;
      // 
      // FrmChooseExportImport
      // 
      AutoScaleDimensions = new SizeF(7F, 15F);
      AutoScaleMode = AutoScaleMode.Font;
      ClientSize = new Size(1113, 559);
      Controls.Add(tableLayoutPanel1);
      Name = "FrmChooseExportImport";
      Text = "FrmChooseExportImport";
