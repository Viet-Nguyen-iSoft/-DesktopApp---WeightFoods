...
{
  partial class FrmChooseModeFunction
  {
    /// <summary>
    ...
    private void InitializeComponent()
    {
      ...
      tableLayoutPanel1.RowStyles.Add(new RowStyle(SizeType.Percent, 8F));
      tableLayoutPanel1.Size = new Size(1125, 604);
      tableLayoutPanel1.TabIndex = 1;
      // 
      // flowLayoutPanel
      // 
      flowLayoutPanel.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
      flowLayoutPanel.Location = new Point(15, 140);
      flowLayoutPanel.Margin = new Padding(0);
      flowLayoutPanel.Name = "flowLayoutPanel";
      flowLayoutPanel.Size = new Size(1095, 423);
      ...
      ucTitleFrm.Size = new Size(1095, 85);
      ucTitleFrm.TabIndex = 2;
      // 
      // FrmChooseModeFunction
      // 
      AutoScaleDimensions = new SizeF(7F, 15F);
      AutoScaleMode = AutoScaleMode.Font;
      ClientSize = new Size(1125, 604);
      Controls.Add(tableLayoutPanel1);
      Name = "FrmChooseModeFunction";
      Text = "FrmChooseMode";
