...
{
  partial class FrmInternalOrExternal
  {
    /// <summary>
    ...
    private void InitializeComponent()
    {
      ...
      tableLayoutPanel1.RowStyles.Add(new RowStyle(SizeType.Percent, 8F));
      tableLayoutPanel1.Size = new Size(784, 587);
      tableLayoutPanel1.TabIndex = 2;
      // 
      // flowLayoutPanel
      // 
      flowLayoutPanel.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;
      flowLayoutPanel.Location = new Point(15, 138);
      flowLayoutPanel.Margin = new Padding(0);
      flowLayoutPanel.Name = "flowLayoutPanel";
      flowLayoutPanel.Size = new Size(754, 409);
      ...
      ucTitleFrm.Size = new Size(754, 85);
      ucTitleFrm.TabIndex = 2;
      // 
      // FrmInternalOrExternal
      // 
      AutoScaleDimensions = new SizeF(7F, 15F);
      AutoScaleMode = AutoScaleMode.Font;
      ClientSize = new Size(784, 587);
      Controls.Add(tableLayoutPanel1);
      Name = "FrmInternalOrExternal";
      Text = "FrmInternalOrExternal";
